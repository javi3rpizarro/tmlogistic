...
?>
    ...
    <ul class="uk-slideshow-items">
        ...
        <li>
            ...
            <div class="uk-slideshow-caption uk-position-center uk-position-small uk-text-center uk-light">
                <h3 class="uk-slideshow-title uk-margin-remove animated fadeIn">Generators</h3>
                <p class="uk-slideshow-subtitle uk-margin-remove animated fadeInUp">State-of-the-art generator sets for maritime, mining, industrial environments, etc.</p>
                <button onclick="window.location.href='<?=base_url()?>servicios/generadores'" class="uk-slideshow-button animated fadeIn">See generators</button>
            </div>
        </li>
        <li>
            <img src="<?=base_url()?>assets/images/home/61_9.png" alt="" uk-cover>
            <div class="uk-slideshow-caption uk-position-center uk-position-small uk-text-center uk-light">
                <h3 class="uk-slideshow-title uk-margin-remove animated fadeInDown">Supply of spare parts and technical supplies</h3>
                <p class="uk-slideshow-subtitle uk-margin-remove animated fadeIn">We offer equipment, spare parts, pieces and parts for all the systems of a ship.</p>
                <button  onclick="window.location.href='<?=base_url()?>servicios#logistica'" class="uk-slideshow-button animated fadeIn">See more</button>
            </div>
        </li>
    </ul>
    ...
    <div class="uk-child-width-expand@s uk-text-center" uk-grid>
        <div>
            <div class="uk-width-expand">
                 ...
                 <h2 class="uk-text-uppercase uk-text-bolder" style="padding: 0px;">SERVICES</h2>
            </div>

            <div class="uk-width-expand">
            
                     <p>
                     Tech-Marine and Logistics is a leading company that offers logistic services, supply of maritime technical and genset rental.
                   </p>  
        ...
        <li>
            <a href="<?=base_url()?>servicios/generadores"><div class="uk-inline-clip uk-transition-toggle">
                ...
                <div class="uk-transition-slide-bottom uk-position-bottom uk-overlay uk-overlay-default">
                        <p class="uk-h4 uk-slider-servicios-title uk-margin-remove">Generators rental</p>
                    </div>
            </div></a>
        </li>
        <li>
            <a href="<?=base_url()?>servicios"><div class="uk-inline-clip uk-transition-toggle">
               ...
               <div class="uk-transition-slide-bottom uk-position-bottom uk-overlay uk-overlay-default">
                        <p class="uk-h4 uk-slider-servicios-title uk-margin-remove">Supply of spare parts and technical supplies</p>
                    </div>
            </div></a>
        </li>
        <li>
            <a href="<?=base_url()?>servicios"><div class="uk-inline-clip uk-transition-toggle">
                ...
                <div class="uk-transition-slide-bottom uk-position-bottom uk-overlay uk-overlay-default">
                        <p class="uk-h4 uk-slider-servicios-title uk-margin-remove">Logistic services</p>
                    </div>
            </div></a>
        </li>
...
<div class=" uk-flex uk-flex-center">
        <a href="<?=base_url()?>servicios" class="uk-proyectos-button">See services</a>
    </div>
   </div>
...
<div id="marcas-container" class="uk-container">
     <div class="uk-flex uk-flex-center">
        <h2 class="uk-text-uppercase uk-text-bolder">Our brands</h2>
    </div>
