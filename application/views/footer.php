    ...
    <div class="uk-width-1-1 uk-width-1-2@m uk-width-1-2@l">
        <div class="uk-text-left uk-margin-left uk-margin-right" uk-grid>
            <div class="uk-width-expand@l uk-padding-remove">
                <p style="color: #fff;">SOBRE NOSOTROS</p>
                <ul class="uk-list uk-footer-links">
                    <li><a href="<?=base_url()?>empresa#quienes-somos">¿Quiénes somos?</a></li>
                    <li><a href="<?=base_url()?>empresa#vision-mision">Misión y Visión</a></li>
                    <li><a href="<?=base_url()?>empresa#nuestros-valores">Nuestros Valores</a></li>
                </ul>
            </div>
            <div class="uk-width-expand@l uk-padding-remove">
