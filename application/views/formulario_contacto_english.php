...
?>
    ...
    <div id="contactanos-container" class="uk-container">
        <div class="uk-flex uk-flex-center">
            <h2 class="uk-text-uppercase uk-text-bolder" style="letter-spacing: 1px">Contact Us</h2>            
        </div>
        ...
        <form id="contactoForm" method="post" action="javascript:submitForm(grecaptcha.getResponse(widgetId1));" class="uk-form uk-grid-small uk-width-2-2@s uk-width-2-3@m uk-width-2-3@l uk-form-contactanos" uk-grid>
            <div class="uk-width-1-2@m">
                <input id="nombre" class="uk-input" type="text" name="nombre" placeholder="Full name" required>
            </div>
            <div class="uk-width-1-2@m">
                <input id="correo" class="uk-input" type="email" name="correo" placeholder="Email address" required>
            </div>
            <div class="uk-width-1-2@m">
                <input id="empresa" class="uk-input" type="text" name="empresa" placeholder="Company">
            </div>
            <div class="uk-width-1-2@m">
                <input id="telefono" class="uk-input" type="number" name="telefono" placeholder="Phone number" required>
            </div>
            ...
            <div class="uk-width-1-1@m">
                 <textarea id="mensaje" class="uk-textarea" rows="5" name="mensaje" placeholder="Leave us a message..." required></textarea>
            </div>
            ...
            <div class="uk-width-1-1@m uk-flex uk-flex-center">
                <button class="uk-form-button" type="submit">Submit form</button>
            </div>
        </form>
...
<script type="text/javascript">
  ...
  event.preventDefault()
                ...
                if(response == ''){
                    $('#g-recaptcha-msg').html('Authentication is necessary.');
                }else{
        ...
                        type:  'post',
                        beforeSend: function () {
                                $("#form-res-msg").html("Sending message...");
                        },
